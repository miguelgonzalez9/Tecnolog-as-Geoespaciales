...
## Datos de transferencias SGP están por cada mes del 2019. Leer datos de cada mes. 
## dat es una lista donde cada elemntos es una base de datos de un mes del 2019.
...
## Convertir fecha lista 6. Fecha mal leída. 
...
## Valor de tranferencia leida como caracter, eliminar puntos y comas y convertir en formato numérico.
...
## Eliminar palabra "municipio" en nombre de municipio.
...
## Eliminar nombres de departamentos en nombres de municipios.
dpto <- c("AMAZONAS",
          "ANTIOQUIA",
          "ATLANTICO",
          "BOLIVAR",
...
## Join con nombre municipio como identificador.
...
## Probelma: municipios no tienen identificador. Si se agrupan los datos por nombre se juntan los municupios con el mismo nombre. 
##  Solución: identificación municipios repetidos, eliminación de dichas observaciones. 
## Pérdida de obs = 276.
